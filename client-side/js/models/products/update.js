...
$(document).ready(function () {
  ...
  $(document)
    ...
    .on("click", "#editProduct", function () {
      ...
      console.log(product);
      // all-input-product
      $("#product-refsupplier-update").val(product.productsupplier);
      $("#product-refsupplier-updateval").val(product.productsupplier);
      $("#product-refcategory-update").val(product.productcategoryname);
      $("#product-refcategory-updateval").val(product.productcategoryname);
      ...
      $("#edit-product-submit").on("click", () => {
        ...
        const productCategory = parseInt$(
          "#product-refcategory-updateval"
        ).val();
        const productSupplier = parseInt$(
          "#product-refsupplier-updateval"
        ).val();
