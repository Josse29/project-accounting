...
import { getStockCSVAPI } from "../../services/stock";
import { convertCSV } from "../../utils";

const ModalCsvStock = (props) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const stocks = await getStockCSVAPI(data);
      await convertCSV({
        data: stocks,
        setSuccessMsg,
        setErrMsg,
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Modal.Footer>
          <Button
            type="button"
            title="Cancel"
            className="bg-red-600 hover:bg-red-700 hover:ring-red-600"
          ...
          <Button
            ...
            className={`bg-green-500 ${
              loading
                ...
                : "cursor-pointer hover:bg-green-600 hover:ring-green-600"
            }`}
